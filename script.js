...
TEST DATA 1: Marks weights 78 kg and is 1.69 m tall. John weights 92 kg and is 
1.95 m tall.
...
message can be either "Mark's BMI is higher than John's!" or "John's BMI is 
higher than Mark's!"
...
a score of at least 100 points. HINT: Use a logical operator to test for minimum
...
//writing the previous code with else if
if (day === 'monday') {
  console.log('Plan course structure');
  console.log('Go to coding meetup');
} else if (day === 'tuesday') {
